...
from sklearn.metrics import accuracy_score, classification_report, roc_auc_score, r2_score, mean_squared_error
import pickle
...
with open('honey_purity_rf_model.pkl', 'wb') as f:
    pickle.dump(rf, f)

print("Model saved as honey_purity_rf_model.pkl")
